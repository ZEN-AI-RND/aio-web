...
// `zaraArt`, when given, is the path to the ZARA cut-out: she replaces the
// mark's disc, holding the rotating mark in her palm (see HeroArt.jsx).
export default function SplashScreen({ onReveal, showMs = SPLASH_FIRST_MS, zaraArt }) {
...
function SplashOverlay({ onReveal, showMs, zaraArt, onDone }) {
      ...
      >
        {zaraArt ? (
          <HeroArt
            ...
            sizeClass="w-[min(88vw,calc(70svh*0.681))]"
        ...
        <p className={`${zaraArt ? "mt-4 sm:mt-6" : "mt-10 sm:mt-12"}  text-xl font-bold tracking-[-0.01em] !text-white sm:text-3xl`}>
